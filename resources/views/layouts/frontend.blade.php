...
<head>
    ...
    <title>@yield('title', 'Catasky - Premium B2B Catalogue')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-premium">
        <div class="container">
            ...
            <a class="navbar-brand d-flex align-items-center gap-3" href="{{ route('home') }}">
                ...
                @else
                    ...
                    <div class="d-flex flex-column leading-none">
                        <span class="fw-bold fs-4 text-gradient mb-0" style="letter-spacing: -0.5px; line-height: 1;">Catasky</span>
                        <span class="text-secondary small-text fw-semibold" style="font-size: 0.65rem; letter-spacing: 1px; text-transform: uppercase;">Smart Catalogue</span>
                    </div>
                @endif
            </a>
            ...
            <div class="d-flex align-items-center gap-2 d-lg-none">
                ...
                <button class="nav-icon-btn" id="mobile-cart-toggle" onclick="openSelectionModal()">
                    <i class="bi bi-bag-check-fill text-primary"></i>
                    <span class="badge-dot" id="mobile-cart-count">0</span>
                </button>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-1 mt-3 mt-lg-0">
                    ...
                    @auth
                        <li class="nav-item d-lg-none mt-2 pt-2 border-top">
                            <div class="fw-bold px-3 py-2 text-dark small">{{ Auth::user()->name }}</div>
                        </li>
                        <li class="nav-item d-lg-none">
                            <a class="nav-link nav-link-custom" href="{{ route('admin.dashboard') }}"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a>
                        </li>
                        <li class="nav-item d-lg-none">
                    ...
                    @else
                        <li class="nav-item d-lg-none mt-2 pt-2 border-top">
                            <a class="nav-link nav-link-custom fw-semibold" href="{{ route('login') }}"><i class="bi bi-box-arrow-in-right me-2"></i>Log In</a>
                        </li>
                        <li class="nav-item d-lg-none px-3 pb-2">
                            <a href="{{ route('login') }}" class="btn btn-hero-primary w-100 py-2" style="border-radius:12px; font-size:0.9rem;"><i class="bi bi-rocket-takeoff-fill"></i> Start Free</a>
                        </li>
                    @endauth
                </ul>
                ...
                <div class="d-none d-lg-flex align-items-center gap-2 ms-auto">
                    ...
                    <button class="btn btn-premium btn-premium-outline py-2 px-3" id="selection-cart-btn" onclick="openSelectionModal()" style="font-size:0.85rem;">
                        <i class="bi bi-bag-check-fill text-primary"></i> <span class="d-none d-xl-inline">Selection</span>
                        <span class="badge bg-primary text-white rounded-pill ms-1" id="cart-count">0</span>
                    </button>

                    @auth
                        <div class="dropdown">
                            <button class="btn btn-premium btn-premium-outline py-2 px-3 gap-2" data-bs-toggle="dropdown" aria-expanded="false" style="font-size:0.85rem;">
                                <i class="bi bi-person-fill-check text-primary"></i> {{ Str::limit(Auth::user()->name, 12) }}
                            ...
                            <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-4 p-2 mt-2" style="min-width:200px;">
                                ...
                                <li><a class="dropdown-item rounded-3 py-2 px-3 small" href="{{ route('admin.dashboard') }}"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a></li>
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-premium btn-premium-outline py-2 px-4" style="font-size:0.9rem; font-weight:600;">Log In</a>
                        <a href="{{ route('login') }}" class="btn-hero-primary py-2 px-4" style="border-radius:12px; font-size:0.9rem; font-weight:700; text-decoration:none; display:inline-flex; align-items:center; gap:8px;">
    ...
    <footer class="footer-premium py-5 mt-5">
        <div class="container">
            <div class="row g-4 justify-content-between">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <a href="{{ route('home') }}" class="d-flex align-items-center gap-2 text-decoration-none mb-3">
                        ...
                        <span class="fw-bold text-white fs-4" style="letter-spacing: -0.5px;">Catasky</span>
                    </a>
                    <p class="text-white-50 small mb-4" style="max-width: 320px;">
                        The ultimate high-converting B2B catalog compiler. Handpick selection rules, custom brand overlays, and generate smart PDF portfolios seamlessly in seconds.
                    </p>
                    <div class="d-flex gap-2">
                        <a href="#" class="social-icon"><i class="bi bi-facebook text-white-50"></i></a>
                        <a href="#" class="social-icon"><i class="bi bi-twitter text-white-50"></i></a>
                        <a href="#" class="social-icon"><i class="bi bi-linkedin text-white-50"></i></a>
                        <a href="#" class="social-icon"><i class="bi bi-instagram text-white-50"></i></a>
                    </div>
                </div>
            ...
            <div class="border-top border-secondary border-opacity-20 mt-4 pt-4 d-flex flex-column flex-md-row align-items-center justify-content-between text-white-50 small">
                <p class="m-0">&copy; {{ date('Y') }} Catasky Smart Catalogue Systems. All Rights Reserved.</p>
    ...
    <div id="selection-bar" class="floating-bar" style="bottom: 0px !important;">
        <div class="bar-actions w-100 d-flex justify-content-center gap-3">
            ...
            <button class="bar-btn" onclick="openSharingModal('image')" style="background: var(--accent-gradient); border: none; box-shadow: 0 4px 10px rgba(6, 182, 212, 0.35); color: white; font-weight: 700;">
                <i class="bi bi-file-earmark-image-fill text-white d-none d-sm-inline-block"></i> <span class="d-none d-sm-inline">Image PDF</span><span class="d-inline d-sm-none">Image PDF</span>
            </button>
        </div>
    </div>
                    ...
                    <ul class="nav nav-tabs nav-tabs-premium gap-1.5 mb-4" id="sharingTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="image-tab" data-bs-toggle="tab" data-bs-target="#image-pane" type="button" role="tab" aria-controls="image-pane" aria-selected="false">
                                <i class="bi bi-images text-accent" style="margin-right: 8px;"></i>Image PDF
                            </button>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade" id="pdf-pane" role="tabpanel" aria-labelledby="pdf-tab" tabindex="0">
                            <div class="row g-4">
                                <div class="col-md-6 d-flex flex-column">
                                    <h6 class="fw-bold mb-3 text-uppercase text-dark" style="font-size: 0.92rem; letter-spacing: 0.5px;">Full Details PDF Options</h6>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-bold text-secondary text-uppercase" style="font-size: 0.72rem; letter-spacing: 0.5px;">Catalogue Title</label>
                                        <input type="text" class="form-control rounded-3 p-2" id="pdf-catalog-title" value="Premium B2B Product Selection" style="font-size: 0.8rem;">
                                    </div>
                                    <div class="mb-4">
                                        <div class="form-check form-switch p-0 d-flex justify-content-between align-items-center">
                                            <label class="form-check-label fw-bold text-secondary text-uppercase" for="pdf-include-branding" style="font-size: 0.72rem; letter-spacing: 0.5px;">Show "Prepared for client" note</label>
                                            <input class="form-check-input ms-0 premium-switch" type="checkbox" id="pdf-include-branding" checked style="width: 42px; height: 22px;">
                                        </div>
                                    </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 d-flex flex-column justify-content-between">
                                    ...
                                    <div class="d-flex flex-column gap-3 mt-auto">
                                        <button id="pdf-share-btn-images" class="btn btn-premium w-100 py-2.5" onclick="sharePDFSystem('images')" disabled style="opacity: 0.6; pointer-events: none; background: var(--primary-gradient); color: white; font-size: 0.85rem; font-weight: 600; box-shadow: 0 4px 14px rgba(79, 70, 229, 0.25);">
                                            <i class="bi bi-share-fill me-2"></i> Share Image PDF to Any App
                                        </button>
                                        
                                        <button id="pdf-direct-btn-images" class="btn btn-premium w-100 py-2.5" onclick="sharePDFOnWhatsApp('images')" disabled style="opacity: 0.6; pointer-events: none; background: #25D366; color: white; font-size: 0.85rem; font-weight: 600; box-shadow: 0 4px 14px rgba(37, 211, 102, 0.25);">
                                            <i class="bi bi-whatsapp me-2"></i> Share Image PDF via WhatsApp
                                        </button>

                                        <button id="pdf-download-btn-images" class="btn btn-premium btn-premium-outline w-100 py-2.5 fw-bold" onclick="generatePDFCatalogue('images')" disabled style="opacity: 0.6; pointer-events: none; font-size: 0.8rem;">
                                            <i class="bi bi-file-earmark-pdf me-2"></i> Download Image PDF
                                        </button>

                                        <!-- Alternative Export Options Accordion -->
                                        <div class="accordion border-0 mt-2" id="altExportsAccordion">
                                            <div class="accordion-item border-0 bg-transparent">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed py-2 px-0 bg-transparent shadow-none border-0 text-secondary fw-bold text-uppercase" type="button" data-bs-toggle="collapse" data-bs-target="#altExportsCollapse" aria-expanded="false" aria-controls="altExportsCollapse" style="font-size: 0.72rem; letter-spacing: 0.5px;">
                                                        Alternative Export Options
                                                    </button>
                                                </h2>
                                                <div id="altExportsCollapse" class="accordion-collapse collapse" data-bs-parent="#altExportsAccordion">
                                                    <div class="accordion-body p-0 pt-2 d-flex flex-column gap-2">
                                                        <button id="share-images-dt-btn" class="btn btn-premium w-100 py-2" onclick="shareSeparateImages()" style="background: rgba(37, 211, 102, 0.1); color: #25D366; font-size: 0.75rem; font-weight: 600; border: 1px solid rgba(37, 211, 102, 0.2);">
                                                            <i class="bi bi-whatsapp me-1"></i> Share Separate Images
                                                        </button>
                                                        <button id="share-images-download-btn" class="btn btn-premium btn-premium-outline w-100 py-2 fw-bold" onclick="downloadAllCards()" style="font-size: 0.75rem; border: 1px solid #cbd5e1; background: transparent; color: #475569;">
                                                            <i class="bi bi-download me-1"></i> Download All Card Images
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="premium-card bg-white border rounded-4 d-flex flex-column h-100" style="min-height: 520px; overflow: hidden;">
                                        <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom" style="flex-shrink:0;">
                                            <span class="small fw-bold text-secondary text-uppercase"><i class="bi bi-eye-fill text-accent"></i> Image PDF Preview</span>
                                        ...
                                        <div id="pdf-preview-loader-images" class="d-flex flex-column justify-content-center align-items-center flex-grow-1 py-5">
                                            ...
                                            <span class="text-secondary small fw-bold text-uppercase" style="letter-spacing: 0.5px; font-size: 0.75rem;">Building image PDF preview...</span>
                                        </div>
                                        ...
                                        <div id="pdf-preview-frame-images" class="d-none w-100 flex-grow-1" style="overflow: hidden; position: relative; background: #f1f5f9; min-height: 460px;">
                                            <!-- Full-width scaled PDF preview: scale is set dynamically via JS -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('change keyup', '#share-catalog-title, #share-show-title, #share-show-price, #share-add-watermark, #share-add-note, #share-note-text', function() {
                if ($('#image-tab').hasClass('active')) {
                    generateLivePDFPreview('images');
                } else {
            ...
            window.downloadAllCards = function() {
                ...
                const btn = $('#share-images-download-btn');
                ...
                fetchMultipleProductDetails(selectedProducts).then(() => {
                    ...
                    Promise.all(promises).then(async dataList => {
                        ...
                        alert(`Successfully generated and downloaded ${count} product card images!`);
                    }).catch(err => {
                        console.error("Download failed:", err);
                        btn.removeAttr('disabled').html(origHtml);
                        alert("Failed to download cards: " + err.message);
                    });
                });
            };
            ...
            async function captureAndDownloadCard(p, imgUrl, filename) {
                ...
                // Build the high-fidelity 800px x 800px card template
                const cardHtml = renderCardForExportHtml(p, imgUrl);
                ...
                // Wait for image inside compiled page to fully load
            ...
            window.shareSeparateImages = function() {
                let phone = $('#share-customer-phone').val();
                const title = $('#share-catalog-title').val() || 'Premium Selection';

                if (!phone || phone.trim() === '') {
                    phone = prompt("Enter customer's WhatsApp number (with country code, e.g. 91xxxxxxxxxx) to share separate cards:");
                }
                ...
                if (selectedProducts.length === 0) {
                    alert('Your selection cart is empty.');
                    return;
                }

                const btn = $('#share-images-dt-btn');
                ...
                fetchMultipleProductDetails(selectedProducts).then(() => {
                    ...
                    Promise.all(promises).then(async dataList => {
                        ...
                        for (let i = 0; i < validDataList.length; i++) {
                            ...
                            const showGallery = $('#share-show-gallery').is(':checked');
                            if (showGallery && data.gallery_urls && data.gallery_urls.length > 0) {
                                totalCount += data.gallery_urls.length;
                            }
                        }
                        ...
                        for (let i = 0; i < validDataList.length; i++) {
                            ...
                            statusLog.html(`
                                <span class="spinner-border spinner-border-sm me-2" role="status"></span>
                                Generating and uploading card ${currentIdx} of ${totalCount}...
                            `);
                            
                            const imgUrl = data.thumbnail_url || '';
                            const blobPrimary = await captureCardAsBlob(p, imgUrl);
                            const uploadUrlPrimary = await uploadTempImageBlob(blobPrimary, `card_${p.id}_primary.png`);
                            if (uploadUrlPrimary) {
                                imageUrls.push(uploadUrlPrimary);
                            }
                            ...
                            if (showGallery && data.gallery_urls && data.gallery_urls.length > 0) {
                                for (let gIndex = 0; gIndex < data.gallery_urls.length; gIndex++) {
                                    ...
                                    statusLog.html(`
                                        <span class="spinner-border spinner-border-sm me-2" role="status"></span>
                                        Generating and uploading gallery card ${currentIdx} of ${totalCount}...
                                    `);
                                    const gImgUrl = data.gallery_urls[gIndex];
                                    const blobGallery = await captureCardAsBlob(p, gImgUrl);
                                    const uploadUrlGallery = await uploadTempImageBlob(blobGallery, `card_${p.id}_gallery_${gIndex+1}.png`);
                                    if (uploadUrlGallery) {
                                        imageUrls.push(uploadUrlGallery);
                                    }
                                }
                            }
                        }
            ...
            window.openSelectionModal = function(defaultTab = 'selection') {
                if (selectedProducts.length === 0) {
                    alert("Please select at least one product first to view or share!");
                    return;
                }
            ...
            window.openSharingModal = function(activeTabKey) {
                if (selectedProducts.length === 0) {
                    alert("Select products before building collaterals.");
                    return;
                }
            ...
            function clearFullSelection() {
                if (confirm("Are you sure you want to deselect all items?")) {
                    selectedProducts = [];
                    localStorage.setItem('selected_products', JSON.stringify(selectedProducts));
                    updateSelectionUISafe();
                    populateModalSelectionList();
            ...
            window.copyShareText = function() {
                ...
                navigator.clipboard.writeText(text).then(function() {
                    alert("Links list successfully copied to clipboard!");
                }).catch(function() {
            ...
            window.shareWithDoubleTick = function() {
                ...
                if (selectedProducts.length === 0) {
                    alert('Your selection cart is empty. Please select products first.');
                    return;
                }
            ...
            window.sharePDFOnWhatsApp = function(type) {
                const typeName = (type === 'details') ? 'B2B Specifications' : 'Compact Visual Flyer';
                const catalogTitle = (type === 'details') ? 
                    ($('#pdf-catalog-title').val() || 'B2B Specifications') : 
                    ($('#pdf-grid-subtitle').val() || 'Compact Visual Flyer');
                ...
                generatePDFBlob(type).then((pdfData) => {
                    ...
                    if (navigator.canShare && navigator.canShare({ files: [file] })) {
                        ...
                        // Desktop/fallback: Prompt for WhatsApp number and send actual PDF document file via DoubleTick API!
                        const phone = prompt("Enter customer's WhatsApp number (with country code, e.g. 91xxxxxxxxxx) to send the actual PDF document directly to their WhatsApp:");
                                ...
                                success: function(response) {
                                    if (response.success && response.url) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(dtResponse) {
                                                btn.removeAttr('disabled').html(originalHtml);
                                                alert(`PDF file successfully sent to WhatsApp number: ${phone}`);
                                                trackAnalyticsEvent('whatsapp_share_pdf_api_success', type);
                                            },
                                            error: function(xhr) {
                                                btn.removeAttr('disabled').html(originalHtml);
                                                alert("Failed to send PDF: " + (xhr.responseJSON?.message || 'Error sending PDF via API'));
                                            }
                                        });
                                    } else {
                                        btn.removeAttr('disabled').html(originalHtml);
                                        alert("PDF upload failed on the server.");
                                    }
                                },
                                error: function(xhr, status, error) {
                                    console.error("PDF upload failed:", error);
                                    btn.removeAttr('disabled').html(originalHtml);
                                    alert("Server upload error occurred.");
                                }
                            });
                        } else {
                                ...
                                success: function(response) {
                                    if (response.success && response.url) {
                                        ...
                                        registerProposalAndGetTrackingUrl(catalogTitle, function(trackingUrl) {
                                            ...
                                            alert("No WhatsApp number entered. Opening WhatsApp chat with tracking links, and downloaded the PDF to your system for manual attachment!");
            ...
            function handleShareError(btn, originalHtml, reason) {
                btn.removeAttr('disabled').html(originalHtml);
                alert("WhatsApp sharing failed: " + reason + ". Sharing only interactive link as fallback.");
                // Fallback to link sharing only
                const catalogTitle = ($('#pdf-catalog-title').val() || 'B2B Specifications');
                registerProposalAndGetTrackingUrl(catalogTitle, function(trackingUrl) {
                    let msg = `📘 *CATASKY SMART CATALOGUE*\n\n`;
                    msg += `🔗 *Press to Open Catalogue:*\n`;
                    msg += `${trackingUrl}`;
            ...
            window.generateLivePDFPreview = function(type = 'details') {
                ...
                const catalogTitle = (type === 'details') ? 
                    ($('#pdf-catalog-title').val() || 'Premium B2B Product Selection') : 
                    ($('#share-catalog-title').val() || 'Compact Visual Matrix Portfolio');
                        ...
                        if (type === 'details') {
                            ...
                            <div class="pdf-page" style="${pageStyle}">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1.5px solid #000000; padding-top: 15px; font-size: 0.78rem; color: #555555; font-family: 'Outfit', sans-serif; margin-top: auto; padding-bottom: 5px;">
                                    <div style="font-weight: bold;">Secure B2B Portfolio &bull; Confidential</div>
                                    <div style="font-weight: bold;">Page 1 of ${totalPages}</div>
                                </div>
                            </div>
                            `;
                        } else {
                            // Compact Image preview gets the customized card flyer style
                            const overlayCount = validDataList.length - 6;
                            let cellsHtml = '';
                            
                            // Render up to 6 cell slots
                            const maxSlots = Math.min(validDataList.length, 6);
                            for (let index = 0; index < maxSlots; index++) {
                                const data = validDataList[index];
                                const imgUrl = data.thumbnail_url || '';
                                const isSixthWithOverlay = (index === 5 && overlayCount > 0);
                                
                                cellsHtml += `
                                <div style="width: 218px; height: 218px; position: relative; border-radius: 8px; overflow: hidden; background: #ffffff; border: 1.5px solid #E2E8F0; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                                    ${imgUrl 
                                        ? `<img src="${imgUrl}" style="width: 100%; height: 100%; object-fit: cover; display: block;">`
                                        : `<div style="font-size: 0.75rem; color: #94A3B8; font-family:'Outfit', sans-serif;">No Image</div>`
                                    }
                                    ${isSixthWithOverlay 
                                        ? `<div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.65); display: flex; align-items: center; justify-content: center; color: #ffffff; font-size: 2.8rem; font-weight: 800; font-family: 'Outfit', sans-serif; letter-spacing: -1px;">
                                            +${overlayCount}
                                           </div>`
                                        : ''
                                    }
                            ...
                            // If less than 6 products, fill empty slots with clean placeholders
                            if (maxSlots < 6) {
                                for (let fill = maxSlots; fill < 6; fill++) {
                                    cellsHtml += `
                                    <div style="width: 218px; height: 218px; border-radius: 8px; background: #ffffff; border: 1.5px dashed #E2E8F0; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                                        <div style="font-size: 0.75rem; color: #E2E8F0; font-family:'Outfit', sans-serif; font-weight: bold; text-transform: uppercase;">Empty Slot</div>
                                    </div>
                                    `;
                                }
                            }
                            ...
                            previewPageHtml = `
                            <div class="pdf-page" style="${cardStyle}">
                                <!-- Logo Only Header -->
                                <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; font-family: 'Outfit', sans-serif;">
                                    <div style="display: flex; align-items: center;">
                                        ${companyLogo && companyLogo.trim().length > 0 
                                            ? `<img src="${companyLogo}" style="max-height: 48px; object-fit: contain;">`
                                    ...
                                    <div style="font-size: 1.5rem; font-weight: bold; color: #000000;">
                                        ${validDataList.length} products
                                    </div>
                                </div>

                                <!-- 3x2 Centered Flex Grid -->
                                <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px; width: 100%; margin: 25px 0; box-sizing: border-box;">
                                    ${cellsHtml}
                                </div>

                                <!-- Category / Selection Subtitle -->
                                <div style="text-align: center; font-size: 2.2rem; font-weight: 900; color: #000000; text-transform: uppercase; letter-spacing: 2px; font-family: 'Outfit', sans-serif; margin-bottom: 30px;">
                                    ${catalogTitle}
                                </div>

                                <!-- Indigo Action Button -->
                                <div style="width: 100%; background: #4F46E5; color: #ffffff; text-align: center; font-size: 1.4rem; font-weight: 800; font-family: 'Outfit', sans-serif; padding: 18px; border-radius: 12px; letter-spacing: 1px; display: flex; align-items: center; justify-content: center; gap: 10px; box-shadow: 0 4px 14px rgba(79, 70, 229, 0.25); text-transform: uppercase; box-sizing: border-box; cursor: pointer;">
                                    PRESS TO OPEN &rarr;
                                </div>
                            </div>
                            `;
            ...
            $('#pdf-cover-color, #pdf-catalog-title, #pdf-include-branding').on('change keyup', function() {
                if ($('#pdf-tab').hasClass('active')) {
                    generateLivePDFPreview('details');
                } else {
                    window.renderedPreviews.details = false;
            ...
            async function buildPDFDocument(type) {
                ...
                if (type === 'details') {
                    ...
                    <div class="pdf-page" style="${cardStyle}">
                        ...
                        <!-- Indigo Action Button -->
                        <div style="width: 100%; background: #1D6FEB; color: #ffffff; text-align: center; font-size: 1.4rem; font-weight: 800; font-family: 'Outfit', sans-serif; padding: 18px; border-radius: 12px; letter-spacing: 1px; display: flex; align-items: center; justify-content: center; gap: 10px; box-shadow: 0 4px 14px rgba(29, 111, 235, 0.25); text-transform: uppercase; box-sizing: border-box; cursor: pointer;">
                            PRESS TO OPEN &rarr;
                        </div>
                    </div>
                    `;
                ...
                // Wait for all images inside the compiled pages to fully load
                ...
                try {
                    for (let i = 0; i < pageElements.length; i++) {
                        ...
                        const canvas = await html2canvas(pageEl, {
                            scale:           2.0, // 2.0 is retina high-definition, compiles twice as fast!
                            useCORS:         true,
                            allowTaint:      true,
                            backgroundColor: '#ffffff',
                            logging:         false,
                        ...
                        if (!canvas || canvas.width === 0 || canvas.height === 0) {
                            throw new Error(`Failed to render canvas for Page ${i+1}`);
                        }
                ...
                for (let i = 0; i < pageCanvases.length; i++) {
                    ...
                    // If this is the visual flyer card page, add the clickable link over "PRESS TO OPEN"
                    if (type !== 'details' && i === 1) {
                        pdf.link(10, 260, 190, 25, { url: targetUrl });
                    }
                }
...
// ── Download PDF (triggers browser save-as dialog) ────────────
            window.generatePDFCatalogue = function(type = 'details') {
                ...
                buildPDFDocument(type).then(function({ pdf, filename }) {
                    ...
                    alert('PDF generation failed: ' + (err.message || err) + '\n\nPlease ensure all product images have loaded.');
                    btn.removeAttr('disabled').html(origHtml);
                });
            };
            ...
            window.sharePDFSystem = function(type) {
                ...
                generatePDFBlob(type).then((pdfData) => {
                    ...
                    if (navigator.canShare && navigator.canShare({ files: [file] })) {
                        ...
                        alert('Your browser or device does not support direct file sharing sheets. We have downloaded the PDF file for you instead!');
                        pdfData.pdf.save(pdfData.filename);
                    }
                }).catch((err) => {
