...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <h3 class="fw-bold text-dark">Create New Subcategory</h3>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0  rounded-4">
                <div class="card-body p-4">
                    <form action="{{ route('subscriber.subcategories.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="p-4 border border-dashed rounded-4 text-center bg-light mb-2">
                                    ...
                                    <p class="small text-muted mb-3">Upload subcategory image (PNG, JPG, WebP)</p>
                            ...
                            <div class="col-12 mt-4 pt-3 border-top d-flex gap-2">
                                <button type="submit" class="btn btn-primary rounded-pill px-4 ">
                                    <i class="fa-solid fa-floppy-disk me-2"></i>Save Subcategory
                                </button>
        ...
        <div class="col-lg-4">
            <div class="card border-0  rounded-4 bg-primary bg-opacity-10 mb-4">
                <div class="card-body p-4 text-primary">
                    ...
                    <p class="small mb-0">Subcategories are secondary classification levels. For example, under "Cables", you can have "Cat6 Cables", "Fibre Patch Cords", etc.</p>
                </div>
            </div>
        </div>
    </div>
