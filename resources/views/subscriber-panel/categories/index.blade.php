...
<div class="container-fluid">
    <div class="row mb-4">
        ...
        <div class="col-md-4 text-md-end">
            <a href="{{ route('subscriber.categories.create') }}" class="btn btn-primary  rounded-pill px-4">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="btn-group  rounded-3 overflow-hidden">
                                            <a href="{{ route('subscriber.categories.edit', $category->id) }}" class="btn btn-white btn-sm px-3" title="Edit Category">
                                                <i class="fa-solid fa-pen-to-square text-primary"></i>
                                            </a>
                                            
                                            <form action="{{ route('subscriber.categories.destroy', $category->id) }}" method="POST" class="d-inline form-delete">
                                                @csrf
                                                @method('DELETE')
