...
<head>
    ...
    @endphp
    <title>Subscriber Sign In | {{ $siteTitle }}</title>
    ...
    <div class="form-panel">
        <div class="form-box">
            ...
            <div class="form-header">
                <h2>Welcome Back 👋</h2>
                <p>Sign in to your subscriber account dashboard</p>
            </div>
            ...
            <!-- Form -->
            <form action="{{ route('subscriber.login.submit') }}" method="POST" id="login-form">
                @csrf
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <a href="{{ route('subscriber.forgot') }}" class="forgot-link">Forgot password?</a>
                    </div>
                    <div class="input-wrap">
            ...
            <div class="text-center mb-3">
                <span style="font-size:0.85rem;color:rgba(255,255,255,0.45);">New subscriber?</span> 
                <a href="{{ route('subscriber.register') }}" class="forgot-link ms-1">Start here to register →</a>
            </div>
