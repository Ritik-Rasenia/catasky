...
<div class="container-fluid">
    <div class="row mb-4">
        ...
        <div class="col-md-4 text-md-end">
            <a href="{{ route('subscriber.brands.create') }}" class="btn btn-primary  rounded-pill px-4">
                        ...
                        <table class="table table-hover align-middle" id="brandTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($brand->image)
                                            <img src="{{ asset('uploads/brands/'.$brand->image) }}" width="45" height="45" class="rounded-3  object-fit-contain bg-white p-1 border">
                                        @else
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="btn-group  rounded-3 overflow-hidden">
                                            <a href="{{ route('subscriber.brands.edit', $brand->id) }}" class="btn btn-white btn-sm px-3" title="Edit Brand">
                                                <i class="fa-solid fa-pen-to-square text-primary"></i>
                                            </a>
                                            
                                            <form action="{{ route('subscriber.brands.destroy', $brand->id) }}" method="POST" class="d-inline form-delete">
                                                @csrf
                                                @method('DELETE')
