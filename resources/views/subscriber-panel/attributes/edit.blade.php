...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0" style="font-size:0.88rem;">
            ...
            <li class="breadcrumb-item active text-indigo fw-semibold" aria-current="page">Edit: {{ $attribute->name }}</li>
        </ol>
    </nav>
@endsection
            ...
            <div class="card premium-card mb-4">
                <div class="card-header premium-card-header d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-0">Modify the specifications and group configurations for your custom attribute.</p>
                    </div>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="unit" class="form-control premium-input" placeholder="e.g. meters, kg, V, mm" value="{{ old('unit', $attribute->unit) }}">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label premium-label">Placeholder <small class="text-muted fw-normal">(optional)</small></label>
                            <input type="text" name="placeholder" class="form-control premium-input" placeholder="e.g. Enter length in meters" value="{{ old('placeholder', $attribute->placeholder) }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label premium-label">Default Value <small class="text-muted fw-normal">(optional)</small></label>
                            <input type="text" name="default_value" class="form-control premium-input" placeholder="Default value for new products" value="{{ old('default_value', $attribute->default_value) }}">
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle mb-0 options-table">
                                ...
                                <tbody id="options-tbody">
                                    {{-- Prepopulate existing options --}}
                                    @foreach($attribute->options as $index => $opt)
                                    <tr class="align-middle">
                                        <td>
                                            <input type="text" name="options[{{ $index }}][label]" class="form-control premium-input px-3 py-2" value="{{ $opt->label }}" required style="font-size:0.85rem;">
                                        </td>
                                        <td>
                                            <input type="text" name="options[{{ $index }}][value]" class="form-control premium-input px-3 py-2" value="{{ $opt->value }}" style="font-size:0.85rem;">
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                        ...
                                        <td class="text-center">
                                            <input type="checkbox" name="options[{{ $index }}][is_default]" value="1" {{ $opt->is_default ? 'checked' : '' }} class="form-check-input" style="width:20px;height:20px;accent-color:#4F46E5;cursor:pointer;">
                                        </td>
                                        <td class="text-center">
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body p-4 d-flex flex-column gap-3">
                    <div class="switch-row">
                        ...
                        <div class="form-check form-switch ps-0 mb-0">
                            <input class="form-check-input ms-0" type="checkbox" name="is_required" id="is_required" value="1" {{ old('is_required', $attribute->is_required) ? 'checked' : '' }} style="width: 42px; height: 22px; cursor: pointer;">
                        </div>
                    </div>
                    ...
                    <div class="switch-row">
                        ...
                        <div class="form-check form-switch ps-0 mb-0">
                            <input class="form-check-input ms-0" type="checkbox" name="is_searchable" id="is_searchable" value="1" {{ old('is_searchable', $attribute->is_searchable) ? 'checked' : '' }} style="width: 42px; height: 22px; cursor: pointer;">
                        </div>
                    </div>
                    ...
                    <div class="switch-row">
                        ...
                        <div class="form-check form-switch ps-0 mb-0">
                            <input class="form-check-input ms-0" type="checkbox" name="show_in_pdf" id="show_in_pdf" value="1" {{ old('show_in_pdf', $attribute->show_in_pdf) ? 'checked' : '' }} style="width: 42px; height: 22px; cursor: pointer;">
                        </div>
                    </div>
                    ...
                    <div class="switch-row">
                        ...
                        <div class="form-check form-switch ps-0 mb-0">
                            <input class="form-check-input ms-0" type="checkbox" name="show_in_share" id="show_in_share" value="1" {{ old('show_in_share', $attribute->show_in_share) ? 'checked' : '' }} style="width: 42px; height: 22px; cursor: pointer;">
                        </div>
                    </div>
                    ...
                    <div class="switch-row">
                        ...
                        <div class="form-check form-switch ps-0 mb-0">
                            <input class="form-check-input ms-0" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $attribute->is_active) ? 'checked' : '' }} style="width: 42px; height: 22px; cursor: pointer;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card premium-card mb-4 bg-light border-0" style="background-color: #F8FAFC !important;">
                <div class="card-body p-4 text-center">
                    <h5 class="fw-bold mb-2 text-dark" style="font-family:'Outfit', sans-serif;">Confirm Updates?</h5>
                    <p class="text-muted small mb-4">Updating custom specs will apply across all products currently using them.</p>
...
<div class="glass-save-bar d-flex justify-content-end align-items-center gap-3">
    ...
    <button type="button" class="btn btn-primary rounded-pill px-4 py-2 fw-semibold shadow-sm transition-all" style="background:#4F46E5; border-color:#4F46E5;" onclick="document.getElementById('attribute-form').submit()">Save Changes</button>
</div>
