                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="unit" class="form-control rounded-3" placeholder="e.g. meters, kg, V, mm" value="{{ old('unit', $attribute->unit) }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="placeholder" class="form-control rounded-3" placeholder="e.g. Enter length in meters" value="{{ old('placeholder', $attribute->placeholder) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="default_value" class="form-control rounded-3" placeholder="Default value for new products" value="{{ old('default_value', $attribute->default_value) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0" style="font-size:0.875rem;">
                            ...
                            <tbody id="options-tbody">
                                ...
                                <tr>
                                    <td>
                                        <input type="text" name="options[{{ $index }}][label]" class="form-control rounded-3" value="{{ $opt->label }}" required style="font-size:0.82rem;">
                                    </td>
                                    <td>
                                        <input type="text" name="options[{{ $index }}][value]" class="form-control rounded-3" value="{{ $opt->value }}" style="font-size:0.82rem;">
                                    </td>
                                    <td>
                                        <input type="text" name="options[{{ $index }}][color_code]" class="form-control rounded-3" value="{{ $opt->color_code }}" style="font-size:0.82rem;">
                                    </td>
        ...
        <div class="card border-0  rounded-4 mb-3">
            ...
            <div class="card-body px-4 pb-4">
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" name="is_required" id="is_required" value="1" {{ old('is_required', $attribute->is_required) ? 'checked' : '' }}>
                    <label class="form-check-label fw-semibold small" for="is_required">Required Field <span class="text-danger">*</span></label>
                </div>
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" name="is_searchable" id="is_searchable" value="1" {{ old('is_searchable', $attribute->is_searchable) ? 'checked' : '' }}>
                    <label class="form-check-label fw-semibold small" for="is_searchable">Searchable in filters</label>
                </div>
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" name="show_in_pdf" id="show_in_pdf" value="1" {{ old('show_in_pdf', $attribute->show_in_pdf) ? 'checked' : '' }}>
                    <label class="form-check-label fw-semibold small" for="show_in_pdf">Show in Generated PDFs</label>
                </div>
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" name="show_in_share" id="show_in_share" value="1" {{ old('show_in_share', $attribute->show_in_share) ? 'checked' : '' }}>
