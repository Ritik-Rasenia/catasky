...
@section('page-title', 'Product Import Logs')
@section('breadcrumb')
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('subscriber.products.import') }}" class="btn btn-primary rounded-pill px-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <a href="{{ route('subscriber.products.import-logs.show', $log->id) }}" class="btn btn-sm btn-light-primary rounded-pill px-3">
