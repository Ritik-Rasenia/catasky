...
<div class="container-fluid py-2">
    <form action="{{ route('subscriber.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" id="product-form" class="needs-validation" novalidate>
        @csrf
        @method('PUT')
        <div class="row">
            {{-- Left Content Area --}}
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="sku" class="form-control"
                                       placeholder="Unique SKU or part identifier" value="{{ old('sku', $product->sku) }}">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <div class="position-relative img-wrap-{{ $img->id }}" style="height:70px;width:70px;">
                                        <img src="{{ asset('uploads/subscriber-products/' . $img->image_path) }}" style="height:70px;width:70px;border-radius:8px;object-fit:cover;border:1px solid #E2E8F0;" class="p-0.5">
