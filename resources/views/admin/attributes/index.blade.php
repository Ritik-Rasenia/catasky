        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center" style="border-top-left-radius:16px; border-top-right-radius:16px;">
                ...
                <div class="d-inline-flex gap-2">
                    <a href="{{ route('admin.saas.approvals.index') }}" class="btn btn-sm btn-outline-secondary" style="border-radius:8px;font-size:0.75rem; display:inline-flex; align-items:center; height:32px;">
                        <i class="bi bi-clock-history me-1"></i> Pending Approvals
                    </a>
                    <a href="{{ route('admin.attributes.create') }}" class="btn btn-sm btn-primary" style="border-radius:8px;font-size:0.75rem; display:inline-flex; align-items:center; height:32px;">
                        <i class="bi bi-plus-lg me-1"></i> Add Global Attribute
                    </a>
                </div>
            </div>
            <div class="card-body p-0">
                    ...
                    <form method="GET" class="row g-2 align-items-center">
                        ...
                        <div class="col-md-3 text-end">
                            <div class="d-inline-flex w-100 justify-content-end">
                                ...
                                <a href="{{ route('admin.attributes.index') }}" class="btn btn-light btn-sm ms-2 px-3" style="border-radius:8px; height:36px; display:inline-flex; align-items:center;">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <table class="table align-middle mb-0" style="font-size:0.875rem;">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="py-3 text-uppercase fs-11 text-muted fw-bold">Subscriber</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($attr->subscriber)
                                        <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3">{{ $attr->subscriber->subscriberProfile->company_name ?? $attr->subscriber->name }}</span>
                                    @else
                                ...
                                <td class="pe-4 text-end">
                                    <div class="d-inline-flex gap-1">
                                        <a href="{{ route('admin.attributes.edit', $attr->id) }}" class="btn btn-sm btn-light border-0" style="border-radius:8px; display:inline-flex; align-items:center; justify-content:center; width:32px; height:32px;" title="Edit Attribute">
                ...
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('admin.attributes.create') }}" class="btn btn-primary rounded-pill px-4 mt-3 fw-semibold">
    ...
    <div class="col-lg-3">
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body py-2">
                {{-- Quick Groups List --}}
                <div class="mb-3">
                    <label class="form-label text-muted fw-semibold fs-11 text-uppercase">Existing Groups</label>
...
<script>
    $(document).on('click', '.btn-delete', function() {
        ...
        Swal.fire({
            ...
            text: "This attribute and all product specifications mapped across CATASKY will be permanently removed!",
            icon: 'warning',
