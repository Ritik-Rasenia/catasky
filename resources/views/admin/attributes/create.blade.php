...
@section('title', 'Add Global Attribute')
@section('page-title', 'Add Global Attribute')
@section('breadcrumb', 'Catalogue → Attributes → Add')
                    ...
                    <div class="card premium-card border-0 mb-4 position-relative overflow-hidden">
                        ...
                        <div class="card-header premium-card-header d-flex align-items-center gap-3 border-0 bg-transparent pt-4 px-4 pb-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-0 mt-0.5">Specify basic parameters and select input type for this global specification template.</p>
                            </div>
                        </div>
                        <div class="card-body p-4 pt-2">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group-premium">
                                        ...
                                        <input type="text" name="name" class="form-control premium-input @error('name') is-invalid @enderror"
                                               placeholder="e.g. Volts, Color, Switch Type" value="{{ old('name') }}" required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group-premium">
                                        <span class="input-icon"><i class="bi bi-collection-fill text-muted"></i></span>
                                        <select name="type" id="attr-type-select" class="form-select premium-input" required style="cursor: pointer; -webkit-appearance: none;">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label premium-label">Unit <small class="text-muted fw-normal">(e.g. kg, V, mm)</small></label>
                                    <input type="text" name="unit" class="form-control premium-input" placeholder="optional" value="{{ old('unit') }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label premium-label">Placeholder</label>
                                    <input type="text" name="placeholder" class="form-control premium-input" placeholder="optional placeholder" value="{{ old('placeholder') }}">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group-premium">
                                        ...
                                        <input type="text" name="default_value" class="form-control premium-input" placeholder="optional fallback value" value="{{ old('default_value') }}">
                                    </div>
                                </div>
                            </div>

                            {{-- Option builder for Select-type --}}
                            <div id="options-builder-card" class="mt-4 pt-4 border-top" style="display:none; border-top: 1.5px dashed #E2E8F0 !important;">
                                    ...
                                    @if($cat->subcategories->count() > 0)
                                        <div class="mb-4 pb-3 border-bottom border-light-premium">
                                            <div class="d-flex align-items-center gap-2 mb-3">
                                                ...
                                                <span class="badge rounded-pill bg-light text-secondary small fw-medium px-2.5 py-1">{{ $cat->subcategories->count() }} subcategories</span>
                                            </div>
                                            <div class="row g-3">
                                                @foreach($cat->subcategories as $subcat)
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="subcat-card d-flex align-items-center justify-content-between p-3 position-relative overflow-hidden" id="card_{{ $subcat->id }}" onclick="toggleCheckbox('subcat_{{ $subcat->id }}')">
                                                            <div class="subcat-glow"></div>
                                                            <div class="d-flex align-items-center z-index-1">
                                                                <input class="form-check-input ms-0 me-2.5 subcat-checkbox" type="checkbox" name="subcategories[]" value="{{ $subcat->id }}" id="subcat_{{ $subcat->id }}" style="width:20px;height:20px;accent-color:#4F46E5; cursor:pointer;" onclick="event.stopPropagation()">
                                                            ...
                                                            <div class="check-icon-wrapper z-index-1">
                                                                <i class="bi bi-check-circle-fill fs-5 check-icon d-none" style="color:#4F46E5;"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                        ...
                        <div class="card-body p-4 pt-2 d-flex flex-column gap-3">
                            <div class="switch-row position-relative overflow-hidden">
                                ...
                                <div class="form-check form-switch ps-0 mb-0 z-index-1">
                                    <input class="form-check-input ms-0" type="checkbox" name="is_required" id="is_required" value="1" style="width: 44px; height: 22px; cursor: pointer;">
                                </div>
                            </div>
                            ...
                            <div class="switch-row position-relative overflow-hidden">
                                ...
                                <div class="form-check form-switch ps-0 mb-0 z-index-1">
                                    <input class="form-check-input ms-0" type="checkbox" name="is_searchable" id="is_searchable" value="1" checked style="width: 44px; height: 22px; cursor: pointer;">
                                </div>
                            </div>
                            ...
                            <div class="switch-row position-relative overflow-hidden">
                                ...
                                <div class="form-check form-switch ps-0 mb-0 z-index-1">
                                    <input class="form-check-input ms-0" type="checkbox" name="is_filterable" id="is_filterable" value="1" checked style="width: 44px; height: 22px; cursor: pointer;">
                                </div>
                            </div>
                            ...
                            <div class="switch-row position-relative overflow-hidden">
                                ...
                                <div class="form-check form-switch ps-0 mb-0 z-index-1">
                                    <input class="form-check-input ms-0" type="checkbox" name="is_comparable" id="is_comparable" value="1" style="width: 44px; height: 22px; cursor: pointer;">
                                </div>
                            </div>
                            ...
                            <div class="switch-row position-relative overflow-hidden">
                                ...
                                <div class="form-check form-switch ps-0 mb-0 z-index-1">
                                    <input class="form-check-input ms-0" type="checkbox" name="is_variant_enabled" id="is_variant_enabled" value="1" style="width: 44px; height: 22px; cursor: pointer;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card premium-card border-0 mb-4 bg-light position-relative overflow-hidden text-center shadow-sm" style="background: linear-gradient(135deg, #1E1B4B 0%, #312E81 100%) !important;">
                        ...
                        <div class="card-body p-4 position-relative z-index-1">
                            <div class="d-inline-flex align-items-center justify-content-center bg-white bg-opacity-10 rounded-pill p-2 mb-3 text-white-50" style="width:60px; height:60px;">
                                <i class="bi bi-rocket-takeoff-fill fs-2 text-indigo-light" style="color: #A5B4FC;"></i>
                            </div>
                            <h5 class="fw-bold mb-2 text-white card-title-outfit">Ready to Publish?</h5>
                            <p class="text-indigo-light small mb-4 opacity-75" style="font-size:0.85rem; color:#E0E7FF;">This global attribute will immediately apply as a specification template for all mapped subcategories in the PIM catalog system.</p>
                            <div class="d-grid gap-3">
                                <button type="submit" class="btn btn-primary rounded-pill py-2.5 fw-semibold shadow transition-all hover-translate-y" style="background:#4F46E5; border-color:#4F46E5; font-family:'Outfit', sans-serif;">
                                    <i class="bi bi-plus-circle me-1.5"></i> Create Attribute
                                </button>
...
<div class="glass-save-bar d-flex justify-content-end align-items-center gap-3">
    ...
    <button type="button" class="btn btn-primary rounded-pill px-4 py-2 fw-semibold shadow-sm transition-all hover-translate-y" style="background:#4F46E5; border-color:#4F46E5; font-family:'Outfit', sans-serif; font-size:0.85rem;" onclick="document.getElementById('attribute-form').submit()">Publish Attribute</button>
</div>
