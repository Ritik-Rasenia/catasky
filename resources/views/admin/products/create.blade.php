...
<div class="container-fluid py-2">
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" id="product-form" class="needs-validation" novalidate>
        @csrf
        <div class="row">
            {{-- Left Content Area --}}
            <div class="col-lg-8">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="part_code" class="form-control @error('part_code') is-invalid @enderror"
                                       placeholder="Unique SKU or part identifier" value="{{ old('part_code') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="part_number" class="form-control"
                                       placeholder="Manufacturer Part Number (optional)" value="{{ old('part_number') }}">
                            </div>
                            <div class="col-12">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <div class="upload-dropzone" onclick="document.getElementById('thumbnail-input').click()">
                                ...
                                <input type="file" name="image" class="d-none" accept="image/*" id="thumbnail-input" onchange="previewThumbnail(event)" required>
                            </div>
